...
Default tables: all tables listed below.

Large tables are exported in chunks (by hylak_id range) to subdirectories:
    data/parquet/quantile_labels/000000.parquet
    data/parquet/quantile_labels/200000.parquet
    ...

Small tables are exported as single files:
    data/parquet/eot_run_status.parquet
