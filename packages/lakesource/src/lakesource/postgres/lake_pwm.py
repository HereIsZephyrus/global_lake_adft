...
ON CONFLICT ({conflict_cols}) DO UPDATE SET
    ...
    max_S              = EXCLUDED.max_S,
    mean_S             = EXCLUDED.mean_S,
    integral_S         = EXCLUDED.integral_S,
