"""Fetch quality-filtered af_nearest pairs and lake_area time series."""
...
def load_pairs_and_areas(
    ...
    Quality filtering is pushed down to SQL (excludes anomalous lakes via
    area_anomalies table).

    Args:
        conn: An open psycopg connection to SERIES_DB.

    Returns:
        (pairs, lake_frames): pairs is list of dicts with hylak_id, nearest_id,
