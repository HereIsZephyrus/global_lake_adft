...
TABLE_TO_ENSURE_KEY: dict[str, str] = {
    ...
    "pwm_hawkes_transition_monthly": "pwm_hawkes",
    "eot_hawkes_results": "eot_hawkes",
    "eot_hawkes_lrt": "eot_hawkes",
    "eot_hawkes_transition_monthly": "eot_hawkes",
...
_TABLE_PK: dict[str, tuple[str, ...]] = {
    ...
    "pwm_hawkes_results": ("hylak_id",),
    "pwm_hawkes_lrt": ("hylak_id",),
    "pwm_hawkes_transition_monthly": ("hylak_id", "year", "month"),
    "eot_hawkes_results": ("hylak_id",),
    "eot_hawkes_lrt": ("hylak_id",),
    "eot_hawkes_transition_monthly": ("hylak_id", "year", "month"),
