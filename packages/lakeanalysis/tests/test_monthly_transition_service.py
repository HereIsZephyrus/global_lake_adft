...
from lakeanalysis.monthly_transition import MonthlyTransitionServiceConfig, run_single_lake_service
...
def test_service_can_ignore_frozen_mask() -> None:
    ...
    config = MonthlyTransitionServiceConfig(min_valid_per_month=2, min_valid_observations=33)
