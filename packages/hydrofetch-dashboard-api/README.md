...
| `HYDROFETCH_TILE_MANIFEST` | （若存在）`data/continents/continents_manifest.json` | Dashboard 启动 hydrofetch 时使用的 tile manifest；可设为绝对路径覆盖 |
| `HYDROFETCH_DASHBOARD_API_PORT` | `8050` | 监听端口 |
